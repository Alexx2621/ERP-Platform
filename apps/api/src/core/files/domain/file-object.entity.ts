export type FileObjectStatus = "ACTIVE" | "DELETED";
 ...
 * via `markDeleted` rather than removed: the storage object itself is not
 * deleted synchronously with the metadata row (docs/SECURITY.md "Files").
 */
