    ...
    return {
      ...
      reset: async () => {
        await prisma?.$executeRawUnsafe(
          'TRUNCATE TABLE "audit_entries", "sessions", "user_credentials", "user_preferences", "setting_values", "setting_definitions", "role_assignments", "role_permissions", "roles", "permissions", "companies", "organizations", "memberships", "tenants", "users" CASCADE',
        );
      },
      stop: async () => {
